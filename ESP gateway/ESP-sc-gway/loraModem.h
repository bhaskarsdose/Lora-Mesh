...
//
struct pins {
	uint8_t dio0=2;	// GPIO15 / D8. For the Hallard board shared between DIO0/DIO1/DIO2
	uint8_t dio1=2;	// GPIO15 / D8. Used for CAD, may or not be shared with DIO0
	uint8_t dio2=2;	// GPIO15 / D8. Used for frequency hopping, don't care
	uint8_t ss=5;		// GPIO16 / D0. Select pin connected to GPIO16 / D0
	uint8_t rst=14;		// GPIO 0 / D3. Reset pin not used	
	// MISO 12 / D6
	// MOSI 13 / D7
	// CLK  14 / D5
} pins;
...
// RST  == GPIO14/ PIN14
struct pins {
	uint8_t dio0=2;		// GPIO26 / Dio0 used for one frequency and one SF
	uint8_t dio1=2;		// GPIO26 / Used for CAD, may or not be shared with DIO0
	uint8_t dio2=2;		// GPIO26 / Used for frequency hopping, don't care
